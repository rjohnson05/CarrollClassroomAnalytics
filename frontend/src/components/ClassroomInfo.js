...
import ClassroomDaySchedule from "./ClassroomDaySchedule";
                 ...
                 Loading text is displayed */}
                        {timeBlocks && courseData && (Object.keys(timeBlocks).length > 0 && Object.keys(courseData).length > 0) ?
                            <div className="heatmap">
                                <ClassroomDaySchedule day="M" timeBlockList={timeBlocks['M']} courseData={courseData}/>
                    ...
                    <div className="day">
                        ...
                        {timeBlocks && courseData && (Object.keys(timeBlocks).length > 0 && Object.keys(courseData).length > 0) ?
                            <div className="heatmap">
                                <ClassroomDaySchedule day="T" timeBlockList={timeBlocks['T']} courseData={courseData}/>
                            </div> : timeBlocks && courseData ? <p>No course data available</p> : <p>Loading...</p>}
                    </div>
                    <div className="day">
                        ...
                        {timeBlocks && courseData && (Object.keys(timeBlocks).length > 0 && Object.keys(courseData).length > 0) ?
                            <div className="heatmap">
                                <ClassroomDaySchedule day="W" timeBlockList={timeBlocks['W']} courseData={courseData}/>
                            </div> : timeBlocks && courseData ? <p>No course data available</p> : <p>Loading...</p>}
                    </div>
                    <div className="day">
                        ...
                        {timeBlocks && courseData && (Object.keys(timeBlocks).length > 0 && Object.keys(courseData).length > 0) ?
                            <div className="heatmap">
                                <ClassroomDaySchedule day="th" timeBlockList={timeBlocks['th']}
                    ...
                    <div className="day">
                        ...
                        {timeBlocks && courseData && (Object.keys(timeBlocks).length > 0 && Object.keys(courseData).length > 0) ?
                            <div className="heatmap">
                                <ClassroomDaySchedule day="F" timeBlockList={timeBlocks['F']} courseData={courseData}/>
                            </div> : timeBlocks && courseData ? <p>No course data available</p> : <p>Loading...</p>}
                    </div>
                </div>
            </div>
